package org.example.data.es.demo;


import org.assertj.core.util.Lists;
import org.example.data.es.demo.es.Author;
import org.example.data.es.demo.es.Topic;
import org.example.data.es.demo.es.TopicRepository;
