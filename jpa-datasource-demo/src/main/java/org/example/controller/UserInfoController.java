...
public class UserInfoController {
     ...
     */
    @GetMapping("/user/{id}")
    public UserInfo getUserInfoFromPath(@PathVariable(value = "id",required = false) UserInfo userInfo) {
        return userInfo;
    }
     ...
     */
    @GetMapping("/user")
    public UserInfo getUserInfoFromRequestParam(@RequestParam(value = "id",required = false) UserInfo userInfo) {
        return userInfo;
    }
